Vagrant.configure("2") do |config|
	...
	config.vm.define "node1" do |node1|
		...
		node1.vm.provision :shell, :inline => "git clone https://github.com/vdloo/daust; cd daust; ./bootstrap && ./configure && make && make install && su vagrant -c \"daustd -d\""
	end
	config.vm.define "node2" do |node2|
		...
		node2.vm.provision :shell, :inline => "git clone https://github.com/vdloo/daust; cd daust; ./bootstrap && ./configure && make && make install && su vagrant -c \"daustd -d\""
	end
end
